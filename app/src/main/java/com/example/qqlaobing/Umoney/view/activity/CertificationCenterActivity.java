...
//                                list[8]="未认证";
//                            }
                            certificationAdapter = new CertificationAdapter(CertificationCenterActivity.this,data1,inco,list);
...
//                                        certificationAdapter.notifyDataSetChanged();
                        ...
                        mAuthBuilder.faceAuth(CertificationCenterActivity.this);
                        break;
                    case 1:
                        if (list[0].equals("已认证")){
